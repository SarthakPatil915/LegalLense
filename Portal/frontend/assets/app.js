...
(function (global) {
  ...
  function statusMeta(status) {
    switch (status) {
      ...
      case "partial": return { label: "Partially Compliant", icon: "warning" };
      case "manual_review": return { label: "Manual Verification", icon: "fact_check" };
      case "not_applicable": return { label: "Not Applicable", icon: "remove_circle_outline" };
